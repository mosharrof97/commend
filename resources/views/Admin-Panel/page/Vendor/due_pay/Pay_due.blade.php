...
<div class="row justify-content-center">
    <div class="col-lg-11 col-sm-12">
        ...
        <div class="card p-4">
            ...
            <div class="card-body">
                <form class="form-inline row g-3" action="{{ route('store.vendor.purchase.due.pay',$vendor->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input type="decimal" name="due" class="form-control col-sm-8" id="due" style="background-color: rgb(218, 218, 218)" value="{{  $vendor->due }}" required="" readonly="">
                            @error('due')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
