                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <div class="" style=" font-size: 17px; font-weight: 700; color:#000; ">Totel Pay -Tk.{{ number_format( $investment->installment->sum('installment_amount'),2,'.',',') }}/-</div>
                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style=" font-size: 17px; font-weight: 700; color:#000; " class="center">{{ number_format( $investment->total_Investment - $investment->installment->sum('installment_amount'),2,'.',',') }} Tk</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
