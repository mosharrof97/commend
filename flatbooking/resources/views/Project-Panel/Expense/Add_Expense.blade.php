                ...
                <form class="" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 ">
                        <div class="form-group col-md-6 row mb-3">
                            ...
                            <input type="date" class="form-control col-sm-9" id="date" name="date" value="">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="decimal" class="form-control " id="total" name="total" style="background-color: rgb(218, 218, 218)" value="0" required="" readonly="">
                                                </td>
                                                <td></td>
                                            </tr>
                                        </tfoot>
